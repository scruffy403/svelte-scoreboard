...
var app = (function () {
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button0, file$2, 23, 2, 465);
    			attr_dev(button1, "class", "btn btn-dark");
    			add_location(button1, file$2, 24, 2, 519);
    			attr_dev(input, "type", "number");
    			add_location(input, file$2, 25, 2, 585);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$2(ctx) {
    	...
    	let if_block1 = /*showControls*/ ctx[2] && create_if_block$1(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$2, 17, 2, 307);
    			attr_dev(h1, "class", "svelte-o2gch5");
    			add_location(h1, file$2, 15, 1, 291);
    			attr_dev(h3, "class", "svelte-o2gch5");
    			add_location(h3, file$2, 21, 1, 417);
    			attr_dev(div, "class", "card");
    			add_location(div, file$2, 14, 0, 271);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class Player extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$2, create_fragment$2, safe_not_equal, { name: 1, points: 0 });
    ...
    /* src/AddPlayer.svelte generated by Svelte v3.38.2 */
    const file$1 = "src/AddPlayer.svelte";
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input0, file$1, 21, 4, 407);
    			attr_dev(input1, "type", "number");
    			attr_dev(input1, "placeholder", "Player Points");
    			add_location(input1, file$1, 23, 4, 487);
    			attr_dev(input2, "type", "submit");
    			input2.value = "Add Player";
    			attr_dev(input2, "class", "btn btn-primary");
    			add_location(input2, file$1, 25, 4, 573);
    			attr_dev(form, "class", "grid-3");
    			add_location(form, file$1, 20, 0, 360);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_if_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(31:1) {#if players.length === 0}",
    		ctx
    	});
    ...
    function create_each_block(ctx) {
    	...
    	player = new Player({
    			props: {
    				name: /*player*/ ctx[2].name,
    				points: /*player*/ ctx[2].points
    			},
    			$$inline: true
    		});
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*players*/ 1) player_changes.name = /*player*/ ctx[2].name;
    			if (dirty & /*players*/ 1) player_changes.points = /*player*/ ctx[2].points;
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(34:2) {#each players as player}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 28, 0, 410);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
