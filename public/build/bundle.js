...
var app = (function () {
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button0, file$2, 29, 2, 700);
    			attr_dev(button1, "class", "btn btn-dark");
    			add_location(button1, file$2, 30, 2, 754);
    			attr_dev(input, "type", "number");
    			add_location(input, file$2, 31, 2, 820);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button0, file$2, 22, 2, 465);
    			attr_dev(button1, "class", "btn btn-danger btn-sm");
    			add_location(button1, file$2, 25, 8, 575);
    			attr_dev(h1, "class", "svelte-o2gch5");
    			add_location(h1, file$2, 20, 1, 449);
    			attr_dev(h3, "class", "svelte-o2gch5");
    			add_location(h3, file$2, 27, 1, 652);
    			attr_dev(div, "class", "card");
    			add_location(div, file$2, 19, 0, 429);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input1, file$1, 22, 4, 482);
    			attr_dev(input2, "type", "submit");
    			input2.value = "Add Player";
    			attr_dev(input2, "class", "btn btn-primary");
    			add_location(input2, file$1, 23, 4, 563);
    ...
    function create_if_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(35:1) {#if players.length === 0}",
    		ctx
    	});
    ...
    function create_each_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(38:2) {#each players as player}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 32, 0, 510);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
